...
import dea.ba.hsalbsig.pistool.fragments.dummy.RoomContent.RoomItem;
...
public class MyRoomRecyclerViewAdapter extends RecyclerView.Adapter<MyRoomRecyclerViewAdapter.ViewHolder> {
    ...
    public MyRoomRecyclerViewAdapter(List<RoomItem> items, RoomFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
